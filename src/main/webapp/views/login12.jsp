        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-login">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="login-form" action="/app/login" method="post" userRole="form" style="${loginStyle}">
                            ...
                            <form id="register-form" action="/app/registration" method="post"
                                ...
                                <div class="form-group">
                                    <input type="email" name="email" id="register_email" tabindex="2"
                                ...
                                <div class="form-group">
                                    <input type="password" name="password" id="register_password" tabindex="3"
                                ...
                                <div class="form-group">
                                    <input type="date" name="birthday" id="register_password" tabindex="4"
